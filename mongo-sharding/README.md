...
Проект демонстрирует реализацию шардирования MongoDB.

В рамках задания реализованы:
- MongoDB Cluster с двумя шардами
- mongos как единая точка входа
- распределение данных по шардам
- приложение, работающее через mongos
...
Скрипт выполняет:
- инициализацию сервера конфигурации
- инициализацию shard1 и shard2
